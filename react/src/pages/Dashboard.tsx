...
function Dashboard() {
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="bg-gray-900 w-80 flex flex-col justify-between text-white">
        <div>
          ...
          <ul className="space-y-2 px-4">
            <li>
              <Link to="home" className="flex px-2 py-2 text-m hover:bg-gray-700 rounded">
            ...
            <li>
              <Link to="users" className="flex px-2 py-2 text-m hover:bg-gray-700 rounded">
              <svg className="mr-3 h-6 w-6 text-gray-400 group-hover:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" width="24" height="24"> 
            ...
            <li>
              ...
              <Link to="media" className="flex px-2 py-2 text-m hover:bg-gray-700 rounded">
        ...
        <div className="p-4 text-m text-red ">
          <button
            onClick={() => {
              localStorage.removeItem("username");
              navigate("/");
            }}
            className=" flex  w-full text-left hover:bg-gray-700 px-2 py-2 rounded">
                <svg className="w-4 mr-4 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16">
                <path stroke="red" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8h11m0 0-4-4m4 4-4 4m-5 3H3a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h3"/>
                </svg>
            Sign out
          </button>
        </div>
